...
<body>
    <div class="container">
        ...
        <?php if(isset($_POST['submit'])): ?>
            ...
            <?php
            $userUrl= $_POST['video_link'];
            // Custom code
            function yturl_id($ytUrl_fun)
            {
                if (stristr($ytUrl_fun,'youtu.be/'))
                    {preg_match('/(https:|http:|)(\/\/www\.|\/\/|)(.*?)\/(.{11})/i', $ytUrl_fun, $final_yturl); return $final_yturl[4]; }
                else 
                    {@preg_match('/(https:|http:|):(\/\/www\.|\/\/|)(.*?)\/(embed\/|watch.*?v=|)([a-z_A-Z0-9\-]{11})/i', $ytUrl_fun, $IDD); return $IDD[5]; }
            }
            $video_link = 'https://www.youtube.com/watch?v='.yturl_id($userUrl);
            ...
            $formats1 = $video->streamingData; //Custom
            ...
            // My Custom code
            // echo $thumbnails[4]->url;

            // var_dump($my);
            // var_dump($thumbnails[1]);
            // var_dump($thumbnails[2]);
            // var_dump($thumbnails[3]);
            // var_dump(thumbnails[4]->url);
            ?>
            ...
            <div class="row formSmall">
                ...
                <div class="col-lg-9">
                    ...
                    <!--Custom line added-->
                    <p><?php echo $short_description; ?></p> <!--YT video Description-->
                </div>
            </div>
